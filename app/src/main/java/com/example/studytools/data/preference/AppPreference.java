...
import static com.example.studytools.data.preference.PreferenceKey.TYPE;
...
public class AppPreference {
    ...
    public static void setData(Context context, User user) {
        ...
        prefEditor.putInt(TYPE, user.getType());
        prefEditor.apply();
    }
    ...
    public static User getData(Context context) {
        ...
        User user = new User(id, name, email, mobile, username, password,image,type);
