...
public class StudentQuizActivity extends AppCompatActivity implements OnPageChangeListener, OnPageErrorListener {
    ...
    private ArrayList<Answer> answeredList;
    ...
    private void checkAnswer() {
        ...
        answeredList.add(new Answer(currentAnswer.getExamId(), currentAnswer.getQuestionNum(), answerNr));
    ...
    private void finishQuiz() {
        ...
        intent.putParcelableArrayListExtra("answeredList", answeredList);
