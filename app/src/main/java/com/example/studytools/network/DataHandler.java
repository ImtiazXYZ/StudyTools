...
import com.example.studytools.activity.AdminProfileActivity;
import com.example.studytools.activity.LoginActivity;
import com.example.studytools.activity.student.StudentProfileActivity;
import com.example.studytools.activity.teacher.TeacherProfileActivity;
import com.example.studytools.adapters.ExamListAdapter;
import com.example.studytools.adapters.ResultListAdapter;
import com.example.studytools.adapters.FileListAdapter;
...
import com.example.studytools.models.Course;
...
public class DataHandler {
            ...
            public void onResponse(String response) {
                try {
                    ...
                    if (!userObject.getString("error").equalsIgnoreCase("no")) {
                        ...
                        AppPreference.setData(context, new User(id, name, email, mobile, username, password,image, Integer.parseInt(type)));
    ...
    public static void signup(final Context context, final User user) {
        ...
        Toast.makeText(context, ""+user.getName()+user.getEmail()+user.getMobile()+user.getUsername()+user.getPassword()+user.getType(), Toast.LENGTH_SHORT).show();
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                stringMap.put("type",""+user.getType());
    ...
    public static void deleteFile(final Context context, int id){
        String url = BASE_URL+"deletefile.php?id="+id;
    ...
    public static void getUserList(final Context context, final CallBack<User> userCallBack) {


        String url = BASE_URL + "pending_users.php";
                ...
                try {
                    ...
                    if (flagObject.getString("success").equalsIgnoreCase("true")) {
                        ...
                        for (int i = 1; i < length; i++) {
                            ...
                            userList.add(new User(userObject.getString("id"),
                                    userObject.getString("username"),
                                    userObject.getString("password")
                                    ));
                        }

                        userCallBack.onSuccess(userList);
    ...
    public static void approveUser(final Context context, final int userid){

        String url = BASE_URL + "approve_users.php?userid="+userid;
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, url, new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
                Toast.makeText(context, "Approved Success", Toast.LENGTH_SHORT).show();
            }
        }, new Response.ErrorListener() {
            @Override
            public void onErrorResponse(VolleyError error) {
